...
const ENABLE_FX_TWITTER = false;
const ENABLE_DREAM = true;

client.on(Events.MessageCreate, async message => {
    if (ENABLE_FX_TWITTER && (message.content.includes('https://twitter.com') || message.content.includes('https://x.com'))) {
        client.channels
        ...
        try {
            ...
            const attach = new AttachmentBuilder(buffer, { name: `dream-${crypto.randomUUID()}.png` });
            client.channels
                .fetch(message.channelId)
